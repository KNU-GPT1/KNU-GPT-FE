...
export async function login({ email, password }: LoginCredentials): Promise<LoginResponse> {
  ...
  const response = await fetch('https://api.knugpt.click/api/v1/auth/login', {
    method: 'POST',
    headers: {
...
export async function sendVerificationCode({ email }: SendCodeParams): Promise<void> {
  ...
  const response = await fetch('https://api.knugpt.click/api/v1/auth/email/code', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function verifyCode({ email, code }: VerifyCodeParams): Promise<void> {
  const response = await fetch('https://api.knugpt.click/api/v1/auth/email/validation', { // https://api.knugpt.click/api/v1/auth/email/verify
    method: 'POST',
...
export async function register(params: RegisterParams): Promise<void> {
  ...
  const response = await fetch('https://api.knugpt.click/api/v1/auth/signup', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
